...
Este repositório visa desenvolver a prática de programação usando a biblioteca Qt.

O projeto consiste em três programas que trabalham em
...
palavras, esse programa é capaz de _escutar_ a rede local e aguardar por
conexões remotas destinadas à _porta_ TCP/1234.
...
servidor implementado neste projeto _escuta_  a _porta_ **1234**. Uma
...
O servidor é capaz de interpretar mensagens em texto simples
...
servidor em execução e lhe enviar comandos **set**.
Espera-se que esse módulo seja capaz de simular um processo
de coleta e envio de dados para o servidor em intervalos de tempo periódicos.
...
O consumidor deve ser capaz de se conectar a um servidor indicado,
