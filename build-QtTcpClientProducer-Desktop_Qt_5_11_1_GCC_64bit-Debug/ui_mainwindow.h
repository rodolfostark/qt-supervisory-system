...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        layoutWidget->setGeometry(QRect(0, 0, 531, 371));
        ...
        horizontalMinSlider = new QSlider(layoutWidget);
        ...
        lcdMinNumber = new QLCDNumber(layoutWidget);
        ...
        horizontalMaxSlider = new QSlider(layoutWidget);
        ...
        lcdMaxNumber = new QLCDNumber(layoutWidget);
        ...
        timingLabel = new QLabel(layoutWidget);
        ...
        timingLabelValue = new QLabel(layoutWidget);
